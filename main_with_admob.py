...
def main(page: ft.Page):
    page.title = "KYOTEI FUND CALCULATOR PRO"
    ...
    <body>
        <div class="ad-container">
            <div class="ad-label">
                ...
                LIVE AdMob Advertisement
            </div>
            <!-- 本物のGoogle AdMob テストバナー広告 -->
    ...
    # 本物のAdMob WebView
    real_admob_webview = ft.Container(
        content=WebView(
            url=f"data:text/html;charset=utf-8,{admob_html}",
            bgcolor="transparent",
        ),
        height=90,
        width=float("inf"),
    ...
    def copy_results(e):
        ...
        copy_text = "🏁 KYOTEI FUND CALCULATOR PRO RESULTS\n"
        copy_text += "=" * 50 + "\n"
        ...
        copy_text += "🔗 Generated by KYOTEI FUND CALCULATOR PRO"
    ...
    main_content = ft.Column([
        real_admob_webview,  # 上部に本物のAdMob広告
        header,
        settings_card,
        main_section,
        suppression_section,
